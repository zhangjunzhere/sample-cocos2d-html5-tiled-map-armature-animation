var MenuLayer = cc.Layer.extend({
    ...
    init: function () {
        ...
        cc.AudioEngine.getInstance().playMusic('asset/audios/seaBackground.mp3', true);
        ...
        this.title = cc.Sprite.create('asset/images/title.png');
        this.title.setPosition(new cc.Point(screen.width / 2, screen.height - 50));
        this.addChild(this.title);

        btSP = cc.Sprite.create('asset/images/buttons/btnPlay_155-34.png');
        // btMP = cc.Sprite.create('asset/images/buttons/btnPlayMulti_155-34.png');
        btCredits = cc.Sprite.create('asset/images/buttons/btnCredits_256-34.png');
        btSPSelected = cc.Sprite.create('asset/images/buttons/btnPlaySelected_155-34.png');
        // btMPSelected = cc.Sprite.create('asset/images/buttons/btnPlayMultiSelected_155-34.png');
        btCreditsSelected = cc.Sprite.create('asset/images/buttons/btnCreditsSelected_256-34.png');
    ...
    onSPlay: function () {
        cc.AudioEngine.getInstance().playEffect('asset/audios/menuSelect.wav');
    ...
    onCredits: function () {
        ...
        this.credits = cc.Sprite.create('asset/screenshots/credits_800-480.png');
